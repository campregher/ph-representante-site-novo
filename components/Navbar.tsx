...
import { Menu, X, ChevronDown, BookOpen, Package } from "lucide-react";
          ...
          >
            <div className="px-4 py-4 space-y-1">
              ...
              <div className="pt-3 space-y-2">
                <Link href="/drop/login" onClick={() => setIsOpen(false)}
