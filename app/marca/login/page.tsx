    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-black text-white">Painel da Marca</h1>
          <p className="text-gray-500 text-sm mt-1">Acesse com as credenciais fornecidas pela PH</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-dark-800 border border-white/10 rounded-2xl p-6 space-y-4">
          ...
          <div className="text-center pt-1">
            <Link href="/marca/recuperar-senha" className="text-xs text-gray-600 hover:text-gray-400 transition-colors">
              Esqueci minha senha
            </Link>
          </div>
        </form>
